<template>
  <div>
    ...
    <form @submit.prevent="saveSettings" class="space-y-4">
      <div>
        <label class="block text-xs font-medium mb-2">Chave do Gemini</label>
        <input
          v-model="form.geminiKey"
          type="password"
          class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs"
      ...
      <div>
        <label class="block text-xs font-medium mb-2">Descrição do Canal</label>
        <textarea
      ...
      <div>
        <label class="block text-xs font-medium mb-2">Nicho Alvo</label>
        <input
      ...
      <div>
        <label class="block text-xs font-medium mb-2">Gírias Customizadas</label>
        <textarea
